...
# User Rspec
echo -e "\E[0;32m \n# Installing Rspec ..."
bundle exec rake app:template LOCATION=$scriptpath/install_rspec_3.7_for_app.rb
...
bundle exec rake app:template LOCATION=$scriptpath/install_jsonapi_resources.rb

git add .
git commit -m 'install jsonapi-resources'

echo -e "\E[0;32m \n# Creating Dockerfile ..."
bundle exec rake app:template LOCATION=$scriptpath/install_docker.rb
